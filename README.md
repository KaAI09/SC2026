...
**대회장 수동 주행 12세션 4,744프레임**을 `camera.yaml`(0714) 로 재생한 결과다.
...
| 캘리브 `--check` | **OK** (차선폭 오차 +1.6~1.8cm · 평행성 0.9~1.1cm · 수직성 2.5~2.8cm) |
...
### 캘리브레이션 (`camera.yaml`, 07142150 — 하드웨어 수정 후 재산출)
